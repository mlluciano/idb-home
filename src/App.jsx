...
const HeroSection = () => {
    return (
        <div className="">
            ...
            <div className="bg-black bg-center absolute inset-0 w-full h-full object-cover overflow-hidden">
                {/*<img*/}
                ...
                {/*/>*/}
                <div className="bg-center absolute inset-0 w-full h-full bg-black bg-no-repeat opacity-75"
